...
datasets = [
    ...
    (noisy_moons, {'damping': .75, 'preference': -220, 'n_clusters': 2, 'n_neighbors': 50}),
...
for i_dataset, (dataset, algo_params) in enumerate(datasets):
    ...
    psc = PSC(model=model, clustering_method=kmeans, test_splitting_rate=0, n_components=params['n_clusters'], n_neighbor=params['n_neighbors'], batch_size_data=10000, random_state=r)
    ...
    for name, algorithm in clustering_algorithms:
        ...
        plot_num += 1
psc.save_model('Synthesis_moons\model.pth')
plt.show()