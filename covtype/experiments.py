...
covertype = fetch_covtype(data_home=None, download_if_missing=True, random_state=None, shuffle=False, return_X_y=False, as_frame=False)
x_tmp = covertype.data
y_tmp = covertype.target
