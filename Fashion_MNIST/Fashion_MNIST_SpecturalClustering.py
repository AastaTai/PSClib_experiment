...
SC_index = sc.fit_predict(X_train_1)
time2 = round(time.time()*1000)
print(f"SC time spent: {time2 - time1} milliseconds")

acc = Accuracy(y_true=y_train_1, y_pred=SC_index)
acc.acc_report()
...
time1 = round(time.time()*1000)
SC_index = sc.fit_predict(X_train_2)
time2 = round(time.time()*1000)
print(f"SC time spent: {time2 - time1} milliseconds")

acc = Accuracy(y_true=y_train_2, y_pred=SC_index)
acc.acc_report()
...
time1 = round(time.time()*1000)
SC_index = sc.fit_predict(X_train_3)
time2 = round(time.time()*1000)
print(f"SC time spent: {time2 - time1} milliseconds")

acc = Accuracy(y_true=y_train_3, y_pred=SC_index)
acc.acc_report()
...
time1 = round(time.time()*1000)
SC_index = sc.fit_predict(X_train_4)
time2 = round(time.time()*1000)
print(f"SC time spent: {time2 - time1} milliseconds")

acc = Accuracy(y_true=y_train_4, y_pred=SC_index)
acc.acc_report()