...
# python NIDS/exp.py --methods kmeans --size -1 --rate 0.1
...
df = pd.read_csv("NIDS/NF-UQ-NIDS-v2.csv", nrows=1040000)
Class = {'Benign': 1, 'DDoS': 2, 'DoS': 3, 'scanning':4, 'Reconnaissance':4, 'xss':4, 'password':4, 'injection':4, 'Bot':4, 'Brute Force':4, 'Infilteration':4, 'Exploits':4, 'Fuzzers':4, 'Backdoor':4, 'Generic':4, 'mitm':4, 'ransomware':4, 'Analysis':4, 'Theft':4, 'Shellcode':4, 'Worms':4}
