...
for i_dataset, (dataset, algo_params) in enumerate(datasets):
    ...
    embedding = spectral_embedding(affinity_matrix_, n_components=params["n_clusters"], eigen_solver='arpack', random_state=1, eigen_tol='auto', drop_first=False)
    ...
    _, labels, _ = k_means(
        X_embedded, n_clusters=params['n_clusters'], random_state=1, n_init=10, verbose=False
    )
